        ...
        <div className="flex">
          ...
          <div className="descripcion mt-56 flex flex-col"> 
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="border border-gray-300 rounded-full w-52 p-2 m-auto">Agregar a la bolsa</button>
              <button className="flex justify-center border border-gray-300 rounded-full w-96 p-2 m-auto"> <IoMdHeartEmpty/>Añadir a favoritos</button>
            </div>
          </div>
        </div>
      </>
